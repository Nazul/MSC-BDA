...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        removeAccountsMenuItem2.setEnabled(false);
        ...
        modifyAccountsMenuItem2.setEnabled(false);
        ...
        removeTransfersMenuItem2.setEnabled(false);
        ...
        modifyTransfersMenuItem2.setEnabled(false);
        ...
        removeAccountsMenuItem.setEnabled(false);
        ...
        modifyAccountsMenuItem.setEnabled(false);
        ...
        removeTransfersMenuItem.setEnabled(false);
        ...
        modifyTransfersMenuItem.setEnabled(false);
...
//            if (account.getId().equals(transfer.getSource().getId()))
//                account.getPendingTransfers().add(transfer);
//            if (account.getId().equals(transfer.getDestination().getId()))
//                account.getPendingTransfers().add(transfer);
//        }
...
//        }
    ...
    private void refreshAccounts() {
        ...
        accounts.stream().forEach((account) -> {
            model.addRow(new Object[]{account.getId(), account.getName(), account.getBalance(), account.getPendingTransfers()});
        });
    }

    private void refreshTransfers() {
        Query<Transfer> query = datastore.createQuery(Transfer.class);
        DefaultTableModel model = (DefaultTableModel)this.transfersTable.getModel();

        transfers = query.asList();
        ...
        transfers.stream().forEach((transfer) -> {
            model.addRow(new Object[]{transfer.getId(), transfer.getSource(), transfer.getDestination(), transfer.getValue(), transfer.getStatus(), transfer.getLastModified()});
        });
    }
